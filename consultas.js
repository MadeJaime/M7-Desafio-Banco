...
const consulta = async ({ cuenta }) => {
    ...
    console.error("Error al consultar las ultimas 10 transferencias", error);    
    }
...
const consultaSaldo = async ({ cuenta }) => {
    ...
    console.log(`El saldo de la cuenta ${cuenta} es: ${saldo}`);
     ...
     console.error("Error al consultar saldo de la cuenta", error);   
    }
